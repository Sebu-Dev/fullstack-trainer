...
const reactQuestions: Question[] = [
  {
    id: uuidv4(),
    questionText:
      "Welche der folgenden Aussagen über Hooks in React sind korrekt?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Was ist der Hauptunterschied zwischen Funktionskomponenten und Klassenkomponenten in React?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Was passiert, wenn der State in einer React-Komponente mit `setState` geändert wird?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Welche der folgenden Aussagen zum `useContext` Hook in React sind korrekt?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Was ist der Zweck von `useReducer` in React und wann sollte es verwendet werden?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Welche der folgenden Aussagen über das bedingte Rendering in React sind korrekt?",
    answerOptions: [
      {
  ...
  {
    id: uuidv4(),
    questionText: "Was ist der Hauptvorteil von React's Virtual DOM?",
    answerOptions: [
      {
  ...
  {
    id: uuidv4(),
    questionText: "Was ist das Ziel von `React.memo()`?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Welche der folgenden Aussagen zum `useEffect` Hook sind korrekt?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Wie kann man das Problem des Prop-Drillings in React vermeiden?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Was passiert, wenn `key` in einer Liste von React-Komponenten fehlt?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Welche der folgenden Aussagen über `useCallback` in React ist korrekt?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Welche der folgenden Aussagen zu React's `useEffect` Hook sind korrekt, wenn eine Abhängigkeitsliste angegeben wird?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Was ist der Hauptzweck des `useLayoutEffect` Hooks in React?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Welche der folgenden Aussagen zu React Context API sind korrekt?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Was passiert, wenn ein `useState` Hook mit einem neuen Wert aufgerufen wird?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Welche der folgenden Aussagen über den `key`-Prop in React sind korrekt?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Welche der folgenden Aussagen zum React Router sind korrekt?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Welche der folgenden Methoden wird verwendet, um Ereignisse in React-Komponenten zu behandeln?",
    answerOptions: [
      {
  ...
  },
  {
    id: uuidv4(),
    questionText:
      "Wie kann der Zustand eines Formulars in React verwaltet werden?",
    answerOptions: [
      {
